...
```bash
pip install --break-system-packages google-genai httpx
```
...
# For image-to-video: load a reference image
...
# Download — CRITICAL: video_bytes is always None, you MUST use the URI + API key
